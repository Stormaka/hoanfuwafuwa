...
public class MyVector3_8000
{
    public float x;
    public float y;
    public float z;

    public MyVector3_8000 (float x, float y, float z)
    {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public MyVector3_8000(Vector3 v)
    {
        this.x = v.x;
        this.y = v.y;
        this.z = v.z;
...
public class Prometheus8000 : MonoBehaviour
{
    ...
    {
        private Prometheus8000 prometheus8000;

        public RpcService(Prometheus8000 prometheus8000)
        {
            this.prometheus8000 = prometheus8000;
        }

        [JsonRpcMethod]
        MyVector3 GetPosition_8000()
        {
            return new MyVector3(prometheus8000.transform.position);
        }

        [JsonRpcMethod]
        public void ResetPosition_8000()
        {
            prometheus8000.ResetPosition(); // Reset the position to the initial position
        }

        [JsonRpcMethod]
        public int GetWallCollision_8000()
        {
            return prometheus8000.wallCollisionDetected;
        }

        [JsonRpcMethod]
        public int GetRewardCollision_8000()
        {
            return prometheus8000.rewardCollisionDetected;
        }

        [JsonRpcMethod]
        public int GetPlaneCollision_8000()
        {
            return prometheus8000.PlaneCollisionDetected;
        }


        [JsonRpcMethod]
        public int CarCollisionDetected_8000()
        {
            return prometheus8000.CarCollisionDetected;
        }
        [JsonRpcMethod]
        public int GetMovingPlaneCollision_8000()
        {
            return prometheus8000.movingPlaneCollisionDetected;
        }
