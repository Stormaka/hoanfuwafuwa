...
public class RayCast5000 : MonoBehaviour
{
    ...
    {
        private RayCast5000 controller;

        public RpcService(RayCast5000 controller)
        {
            this.controller = controller;
        }

        [JsonRpcMethod]
        public RayResults GetRayCastsResults_5000()
        {
            return controller.GetRayCastsResults();
        }

        [JsonRpcMethod]
        public void SomeMethod_5000()
        {
