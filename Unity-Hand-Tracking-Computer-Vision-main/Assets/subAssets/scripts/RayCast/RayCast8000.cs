...
public class RayCast8000 : MonoBehaviour
{
    ...
    {
        private RayCast8000 controller;

        public RpcService(RayCast8000 controller)
        {
            this.controller = controller;
        }

        [JsonRpcMethod]
        public RayResults GetRayCastsResults_8000()
        {
            return controller.GetRayCastsResults();
        }

        [JsonRpcMethod]
        public void SomeMethod_8000()
        {
