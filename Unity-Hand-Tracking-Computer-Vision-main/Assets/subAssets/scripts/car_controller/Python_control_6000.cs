...
public class Python_control_6000 : MonoBehaviour
{
    ...
    {
        private Python_control_6000 controller; // Use the correct class name here

        public RpcService(Python_control_6000 controller) // Use the correct class name here
        {
            this.controller = controller;
        }

        [JsonRpcMethod]
        public void GoForward_6000()
        {
            controller.PrometeoCarController.GoForward();
        }

        [JsonRpcMethod]
        public void GoReverse_6000()
        {
            controller.PrometeoCarController.GoReverse();
        }

        [JsonRpcMethod]
        public void TurnLeft_6000()
        {
            controller.PrometeoCarController.TurnLeft();
        }

        [JsonRpcMethod]
        public void TurnRight_6000()
        {
            controller.PrometeoCarController.TurnRight();
        }

        [JsonRpcMethod]
        public void ResetSteeringAngle_6000()
        {
            controller.PrometeoCarController.ResetSteeringAngle();
        }

        [JsonRpcMethod]
        public void ThrottleOff_6000()
        {
            controller.PrometeoCarController.ThrottleOff();
        }

        [JsonRpcMethod]
        public void Handbrake_6000()
        {
            controller.PrometeoCarController.Handbrake();
        }

        [JsonRpcMethod]
        public void RecoverTraction_6000()
        {
            controller.PrometeoCarController.RecoverTraction();
        }

        [JsonRpcMethod]
        public float CarSpeedUI_6000()
        {
