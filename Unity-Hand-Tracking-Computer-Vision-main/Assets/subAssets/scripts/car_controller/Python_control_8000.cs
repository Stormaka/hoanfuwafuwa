...
public class Python_control_8000 : MonoBehaviour
{
    ...
    {
        private Python_control_8000 controller; // Use the correct class name here

        public RpcService(Python_control_8000 controller) // Use the correct class name here
        {
            this.controller = controller;
        }

        [JsonRpcMethod]
        public void GoForward_8000()
        {
            controller.PrometeoCarController.GoForward();
        }

        [JsonRpcMethod]
        public void GoReverse_8000()
        {
            controller.PrometeoCarController.GoReverse();
        }

        [JsonRpcMethod]
        public void TurnLeft_8000()
        {
            controller.PrometeoCarController.TurnLeft();
        }

        [JsonRpcMethod]
        public void TurnRight_8000()
        {
            controller.PrometeoCarController.TurnRight();
        }

        [JsonRpcMethod]
        public void ResetSteeringAngle_8000()
        {
            controller.PrometeoCarController.ResetSteeringAngle();
        }

        [JsonRpcMethod]
        public void ThrottleOff_8000()
        {
            controller.PrometeoCarController.ThrottleOff();
        }

        [JsonRpcMethod]
        public void Handbrake_8000()
        {
            controller.PrometeoCarController.Handbrake();
        }

        [JsonRpcMethod]
        public void RecoverTraction_8000()
        {
            controller.PrometeoCarController.RecoverTraction();
        }

        [JsonRpcMethod]
        public float CarSpeedUI_8000()
        {
